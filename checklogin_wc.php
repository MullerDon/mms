...
header("Location: management_wc.php"); //What page to redirect to if login is good
}
else
{
$_SESSION['loggedin'] = "false";
header("Location: loginfailed_wc.php"); //what page to redirect to if login failed
}
