...
{
	header ('Location: go_back_kzn.php');
	exit;
}
...
$query= "insert into job_track_kzn values
...
if ($result)
	...
	echo'<strong><br />The Job ID is:  '. "KZN".mysql_insert_id();
	

	mail("jobtrack@weathersa.co.za,donald.muller@weathersa.co.za,siyabonga.mthethwa@weathersa.co.za,edward.barnies@weathersa.co.za
,ashok.rampersad@weathersa.co.za,buhle.shandu@weathersa.co.za,sandile.mdose@weathersa.co.za,rydall.jardine@weathersa.co.za,
riaan.lourens@weathersa.co.za,webster.ngoepe@weathersa.co.za,floyd.ngwato@weathersa.co.za,nomvuzo.busizi@weathersa.co.za",
"New Job logged", "A new job has been logged for the KwaZulu-Natal region -- KZN" .mysql_insert_id()."---The equipment type is $_POST[eqpmnt_type]--The job has been logged by- $emp_id----Station name(s)--$str");
