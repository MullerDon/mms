...
header("Location: management_gau.php"); //What page to redirect to if login is good
}
else
{
$_SESSION['loggedin'] = "false";
header("Location: loginfailed_gau.php"); //what page to redirect to if login failed
}
