...
$query= "insert into job_track_lim values
...
if ($result)
	...
	echo'<strong><br />The Job ID is:  '. "LIM".mysql_insert_id();
	

	mail("jobtrack@weathersa.co.za,donald.muller@weathersa.co.za,rudzani.malala@weathersa.co.za,
buhle.shandu@weathersa.co.za,jannie.ferreira@weathersa.co.za,fapp@weathersa.co.za,titus.mosweu@weathersa.co.za,fath@weathersa.co.za,
sandile.mdose@weathersa.co.za,
rydall.jardine@weathersa.co.za,
riaan.lourens@weathersa.co.za,webster.ngoepe@weathersa.co.za,floyd.ngwato@weathersa.co.za,nomvuzo.busizi@weathersa.co.za",
"New Job logged", "A new job has been logged for the Limpopo region -- LIM" .mysql_insert_id()."---The equipment type is $_POST[eqpmnt_type]--The job has been logged by- $emp_id----Station name(s)--$str");
