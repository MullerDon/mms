...
header("Location: management_nw.php"); //What page to redirect to if login is good
}
else
{
$_SESSION['loggedin'] = "false";
header("Location: loginfailed_nw.php"); //what page to redirect to if login failed
}
