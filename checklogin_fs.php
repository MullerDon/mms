...
header("Location: management_fs.php"); //What page to redirect to if login is good
}
else
{
$_SESSION['loggedin'] = "false";
header("Location: loginfailed_fs.php"); //what page to redirect to if login failed
}
