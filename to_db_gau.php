...
$query= "insert into job_track_gau values
...
if ($result)
	...
	echo'<strong><br />The Job ID is:  '. "GAU".mysql_insert_id();
	

	mail("jobtrack@weathersa.co.za,donald.muller@weathersa.co.za,rudzani.malala@weathersa.co.za,ntobeko.nkangane@weathersa.co.za,
nfcobs@weathersa.co.za,dithuso.mogapi@weathersa.co.za,
buhle.shandu@weathersa.co.za,
sandile.mdose@weathersa.co.za,
jessica.erasmus@weathersa.co.za,rydall.jardine@weathersa.co.za,
riaan.lourens@weathersa.co.za,webster.ngoepe@weathersa.co.za,floyd.ngwato@weathersa.co.za,nomvuzo.busizi@weathersa.co.za",
"New Job logged", "A new job has been logged for the Gauteng region -- GAU" .mysql_insert_id()."---The equipment type is $_POST[eqpmnt_type]--The job has been logged by- $emp_id----Station name(s)--$str");
