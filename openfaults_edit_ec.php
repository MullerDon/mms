...
echo "<td>", "EC".$row['job_id'], "</td><td>", $row['eqpmnt_type'], "</td><td>", $row['fault_descr'], "</td><td>", $row['date_logged'], "</td><td>", $row['fault_status'], "</td><td>", $row['location'], "</td><td>", $row['assigned_tech'], "</td><td>", $row['job_ack'], "</td>";
...
<form action="edit_job_ec.php" method ="post">
<!-------------------------------------------------->
...
<tr>
<td><input type="text" name="date_mancomplete"></td>
</tr>
-->
<br />
...
<td>
<p class="footer">
<a href="edit_close_ec.html">Back</a> 
</p>
</td>
