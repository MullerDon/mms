...
$query= "insert into job_track_fs values
...
if ($result)
	...
	echo'<strong><br />The Job ID is:  '. "FS".mysql_insert_id();
	

	mail("jobtrack@weathersa.co.za,donald.muller@weathersa.co.za,francis.mosetlho@weathersa.co.za,tankiso.seboka@weathersa.co.za,lerato.mabatla@weathersa.co.za,
petrus.mokoena@weathersa.co.za,tumo.xaba@weathersa.co.za,tsholo.naledi@weathersa.co.za,shadrack.podile@weathersa.co.za,
titus.mosweu@weathersa.co.za,buhle.shandu@weathersa.co.za,sandile.mdose@weathersa.co.za,rydall.jardine@weathersa.co.za,
riaan.lourens@weathersa.co.za,webster.ngoepe@weathersa.co.za,floyd.ngwato@weathersa.co.za,nomvuzo.busizi@weathersa.co.za",
"New Job logged", "A new job has been logged for the Freestate region -- FS" .mysql_insert_id()."---The equipment type is $_POST[eqpmnt_type]--The job has been logged by- $emp_id----Station name(s)--$str");
