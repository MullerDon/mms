...
$query = "SELECT job_id, eqpmnt_type, fault_descr, repair_descr FROM job_track_wc
...
echo "<td>", "WC".$row['job_id'], "</td><td>", $row['eqpmnt_type'], "</td><td>", $row['fault_descr'], "</td><td>", $row['repair_descr'], "</td>";
