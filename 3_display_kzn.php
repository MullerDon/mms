...
$query = "SELECT * FROM job_cost_kzn
...
echo "<td>", "KZN".$row['job_id'], "</td><td>", $row['assigtech_cost'], "</td><td>", "R".$row['st_cost'], "</td><td>", "R".$row['accom_cost'], "</td><td>", "R".$row['fuel_cost'], "</td><td>",$row['km_total']."km", "</td>";
