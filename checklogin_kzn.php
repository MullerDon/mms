...
header("Location: management_kzn.php"); //What page to redirect to if login is good
}
else
{
$_SESSION['loggedin'] = "false";
header("Location: loginfailed_kzn.php"); //what page to redirect to if login failed
}
