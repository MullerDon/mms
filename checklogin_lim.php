...
header("Location: management_lim.php"); //What page to redirect to if login is good
}
else
{
$_SESSION['loggedin'] = "false";
header("Location: loginfailed_lim.php"); //what page to redirect to if login failed
}
