...
<tr>
<td width="25%">
Job ID:<br><input type ="text" value="<?php echo 'NW'.$data2['job_id']?>"/> 
</td>
<td width="35%">
...
<td width="35%">  
Original job ID:<br><input type ="text" value="<?php echo 'NW'.$data2['job_repeat_id']?>"/> </br></br>
</td>
</table>
<table border="0" width="100%">
<tr>
...
<form action="10edit_closejob_nw.php" method ="post">
