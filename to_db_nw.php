...
$query= "insert into job_track_nw values
...
if ($result)
	...
	echo'<strong><br />The Job ID is:  '. "NW".mysql_insert_id();
	

	mail("jobtrack@weathersa.co.za,donald.muller@weathersa.co.za,francis.mosetlho@weathersa.co.za,tankiso.seboka@weathersa.co.za,famm@weathersa.co.za,
...
"New Job logged", "A new job has been logged for the North West region -- NW" .mysql_insert_id()."---The equipment type is $_POST[eqpmnt_type]--The job has been logged by- $emp_id----Station name(s)--$str");
