...
$query= "insert into job_track_mp values
...
if ($result)
	...
	echo'<strong><br />The Job ID is:  '. "MP".mysql_insert_id();
	

	mail("jobtrack@weathersa.co.za,donald.muller@weathersa.co.za,rudzani.malala@weathersa.co.za,tebogo.moloi@weathersa.co.za,ken.short@weathersa.co.za,faeo@weathersa.co.za,
...
"New Job logged", "A new job has been logged for the Mpumalanga region -- MP" .mysql_insert_id()."---The equipment type is $_POST[eqpmnt_type]--The job has been logged by- $emp_id----Station name(s)--$str");
