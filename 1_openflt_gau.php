...
<b>All open jobs in the Gauteng database that have not been completed</b><br>
<br />
<?php
...
echo "<td>", "GAU".$row['job_id'], "</td><td>", $row['eqpmnt_type'], "</td><td>", $row['fault_descr'], "</td><td>", $row['date_logged'], "</td><td>", $row['fault_status'], "</td><td>", $row['location'], "</td><td>", $row['assigned_tech'], "</td>";
