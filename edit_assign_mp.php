...
mail("$_POST[assigned_tech]@weathersa.co.za","JOB ASSIGNED TO YOU", "JOB MP$_POST[job_id]--Has been assigned to you, please accept or decline the job");

//-------------------------------------------------------------------------------------------

//-----------------OR simpler code-------------------------------------------------------------------

//mail("$assigned_tech@weathersa.co.za","JOB ASSIGNED TO YOU", "JOB MP$job_id--Has been assigned to you, please accept or decline the job");
