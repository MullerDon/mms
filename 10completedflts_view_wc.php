...
<b>All jobs in the Western Cape database that have been completed but not closed</b><br>
<br />
<?php
...
echo "<td>", "WC".$row['job_id'], "</td><td>", $row['eqpmnt_type'], "</td><td>", $row['fault_descr'], "</td><td>", $row['date_logged'], "</td><td>", $row['repair_descr'], "</td><td>", $row['fault_status'], "</td><td>",$row['date_completed'], "</td><td>", $row['location'], "</td><td>", $row['assigned_tech'], "</td><td>", $row['close_job'], "</td><td>", $row['emp_id'], "</td><td>", $row['job_completed'], "</td>";
...
<td>
<p class="footer">
<a href="10_close_job_wc.php">Back</a> 
</p>
</td>
