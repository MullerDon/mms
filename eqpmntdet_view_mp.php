...
$query = "SELECT eqpmnt_type, fault_descr, repair_descr FROM job_track_mp
...
echo "<td>", "MP".$_POST['job_id'], "</td><td>", $row['eqpmnt_type'], "</td><td>", $row['fault_descr'], "</td><td>", $row['repair_descr'], "</td>";
