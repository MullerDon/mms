...
header("Location: management_mp.php"); //What page to redirect to if login is good
}
else
{
$_SESSION['loggedin'] = "false";
header("Location: loginfailed_mp.php"); //what page to redirect to if login failed
}
