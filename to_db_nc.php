...
$query= "insert into job_track_nc values
...
if ($result)
	...
	echo'<strong><br />The Job ID is:  '. "NC".mysql_insert_id();
	

	mail("jobtrack@weathersa.co.za,donald.muller@weathersa.co.za,johan.stander@weathersa.co.za,peter.roux@weathersa.co.za,natheer.tofa@weathersa.co.za,
nicolene.swart@weathersa.co.za,
franklin.farao@weathersa.co.za,marumo.setlhare@weathersa.co.za,jacques.links@weathersa.co.za,
gerald.meyer@weathersa.co.za,facv@weathersa.co.za,fakm@weathersa.co.za,faup@weathersa.co.za,fasb@weathersa.co.za,
buhle.shandu@weathersa.co.za,sandile.mdose@weathersa.co.za,rydall.jardine@weathersa.co.za,
riaan.lourens@weathersa.co.za,webster.ngoepe@weathersa.co.za,floyd.ngwato@weathersa.co.za,nomvuzo.busizi@weathersa.co.za",
"New Job logged", "A new job has been logged for the Northern Cape region -- NC" .mysql_insert_id()."---The equipment type is $_POST[eqpmnt_type]--The job has been logged by- $emp_id----Station name(s)--$str");
