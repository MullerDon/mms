...
echo "<td>", "EC".$row['job_id'], "</td><td>", $row['eqpmnt_type'], "</td><td>", $row['fault_descr'], "</td><td>", $row['date_logged'], "</td><td>", $row['repair_descr'], "</td><td>", $row['fault_status'], "</td><td>",$row['date_completed'], "</td><td>", $row['location'], "</td><td>", $row['assigned_tech'], "</td><td>", $row['close_job'], "</td><td>", $row['emp_id'], "</td><td>", $row['job_completed'], "</td>";
...
session_start();
$_SESSION['jobmanec'] = $_POST['job_id'];
...
<tr>
<td width="25%">
Job ID:<br><input type ="text" value="<?php echo 'EC'.$data2['job_id']?>"/> 
</td>
<td width="35%">
...
<td width="35%">  
Original job ID:<br><input type ="text" value="<?php echo 'EC'.$data2['job_repeat_id']?>"/> </br></br>
</td>
</table>
<table border="0" width="100%">
<tr>
...
<form action="10edit_closejob_ec.php" method ="post">
...
<td>
<p class="footer">
<a href="10_close_job_ec.php">Back</a> 
</p>
</td>
