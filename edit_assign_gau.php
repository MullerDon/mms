...
$query= "UPDATE job_track_gau SET
...
mail("$_POST[assigned_tech]@weathersa.co.za","JOB ASSIGNED TO YOU", "JOB GAU$_POST[job_id]--Has been assigned to you, please accept or decline the job");

//-------------------------------------------------------------------------------------------

//-----------------OR simpler code-------------------------------------------------------------------

//mail("$assigned_tech@weathersa.co.za","JOB ASSIGNED TO YOU", "JOB GAU$job_id--Has been assigned to you, please accept or decline the job");
